...
function pie(){return `<footer class="ancho pie editorial-pie editorial-franja"><div>Astroplanetario · Un cielo, muchas perspectivas<span class="firma-instituto">Un proyecto del <a href="https://tarot-academy-theta.vercel.app/" target="_blank" rel="noopener">Instituto de Artes Esotéricas y Saberes Ancestrales</a></span></div><div><a href="/predicciones">Predicciones</a> · <a href="/herramientas">Todas las herramientas</a> · <a href="/">Inicio</a></div></footer>`;}
