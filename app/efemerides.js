...
/* Se lee en vivo: el catálogo puede llegar después del motor (carga
   diferida) y CIUDADES debe reflejarlo sin depender del orden de los
   <script>. Antes era una copia tomada al cargar, y bastaba con que
   ciudades.js llegara tarde para que quedara vacía. */
const CIUDADES = [];
Object.defineProperty(CIUDADES, "vivo", {value:true});
...
Object.defineProperty(window.Efem, "CIUDADES", {
  enumerable: true,
  get(){ return (window.Ciudades && window.Ciudades.lista) || CIUDADES; }
});
})();
